...
class EventType(str, Enum):
    ...
    # Milestone v0.5 Interactive Event Types
    AWAITING_INPUT = "AWAITING_INPUT"
    SOCRATIC_PROMPT = "SOCRATIC_PROMPT"
    STUDENT_ACTION_RECORDED = "STUDENT_ACTION_RECORDED"
    TEST_INPUT_EXECUTED = "TEST_INPUT_EXECUTED"
    REVISION_ANALYZED = "REVISION_ANALYZED"
